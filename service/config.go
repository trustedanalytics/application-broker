...
func (c *Config) initialize() {
	...
	flag.StringVar(&c.AppSource, "src", "", "Source of the app to push [/Users/markchma/Code/spring-hello-env]")
	flag.StringVar(&c.AppBaseName, "app", "", "Base app name [spring-hello-env-]")
